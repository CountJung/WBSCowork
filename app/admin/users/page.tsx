    ...
    return (
      <Container component="main" maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
        <Stack spacing={3}>
          <Typography variant="h3">사용자 관리</Typography>
          <Alert severity="warning">
            users 테이블이 아직 준비되지 않았습니다. 먼저 DB 관리 페이지에서 DB와 기본 테이블을 초기화해야 합니다.
          </Alert>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5} sx={{ justifyContent: "space-between" }}>
          <Stack spacing={1}>
            ...
            <Typography variant="body1" color="text.secondary">
              슈퍼유저 전용 페이지입니다. Google 로그인으로 생성된 사용자 목록을 확인하고 일반사용자 또는 게스트 권한을 지정할 수 있습니다.
            </Typography>
          </Stack>
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5}>
            <Button href="/admin" variant="outlined">
        ...
        <Paper elevation={0} sx={{ p: 3, borderRadius: 4 }}>
          <Stack spacing={2}>
            ...
            <Typography variant="body2" color="text.secondary">
              env에 설정된 SUPERUSER_EMAIL 계정은 슈퍼관리자로 고정되며, 새 Google 로그인 사용자는 기본적으로 게스트로 등록됩니다.
            </Typography>
            <Typography variant="body2" color="text.secondary">
