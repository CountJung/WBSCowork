...
export async function createProjectAction(formData: FormData) {
  try {
    ...
    redirect(buildTasksPath("success", `${project.name} 프로젝트를 생성했습니다.`, project.id));
  } catch (error) {
    redirect(
      buildTasksPath(
        "error",
...
export async function createTaskAction(formData: FormData) {
  ...
  try {
    await requireWritableSession(projectId);
    ...
    redirect(buildTasksPath("success", `${task.title} 작업을 생성했습니다.`, projectId));
  } catch (error) {
    redirect(
      buildTasksPath(
        "error",
...
export async function updateTaskAction(formData: FormData) {
  ...
  try {
    ...
    redirect(buildTasksPath("success", `${task.title} 작업을 수정했습니다.`, projectId));
  } catch (error) {
    redirect(
      buildTasksPath(
        "error",
...
export async function deleteTaskAction(formData: FormData) {
  ...
  try {
    ...
    redirect(buildTasksPath("success", `${task.title} 작업을 삭제했습니다.`, projectId));
  } catch (error) {
    redirect(
      buildTasksPath(
        "error",
