...
import type { SettingsActionState, AdminSettingsSnapshot } from "@/src/features/settings-manage";
...
export default function SettingsAdminPanel({ initialSnapshot, saveSettingsAction }: SettingsAdminPanelProps) {
