...
- If a blocker cannot be resolved immediately, add it to docs/TODO.md and docs/HARNESS_MAP.md with the exact command, output summary, impact, and owner action.
...
- Keep docs/HARNESS_MAP.md current with runnable commands, expected outputs, blockers, and environment assumptions.
...
- A stage transition is not complete unless docs/TODO.md and docs/HARNESS_MAP.md reflect the new state.